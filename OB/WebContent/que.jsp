...
<body>
	...
	<section>
		<nav>
			<ul>
				<li><a href="controller?type=board_type=1">공지사항</a></li>
				...
				<table border="1">
					...
					<tfoot>
						<tr>
							...
							<td><input type="button" value="작성하기" onclick="javascript:location.href='controller?type=queWrite&board_type=3'"></td>
						</tr>
					</tfoot>
				</table>
			</div>
